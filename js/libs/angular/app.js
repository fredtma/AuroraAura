...
.config(['$routeProvider','$compileProvider','$sceDelegateProvider',function($routeProvider,$compileProvider,$sceDelegateProvider){
   ...
   $rootScope.menus=[{"link":true,"header":"dropdown-header","text":"Action List"},{"link":true,"icon":"glyphicon glyphicon-user","text":"User Profile","href":href},{"link":true,"icon":"glyphicon glyphicon-flag","text":"Profile List","href":"#joshua/administrator/list"},{"link":true,"icon":"glyphicon glyphicon-briefcase","text":"Clients","href":"#numbers/clients/list"},{"link":true,"icon":"glyphicon glyphicon-hdd","text":"Servers","href":"#leviticus/servers/list"},{"link":true,"icon":"glyphicon glyphicon-road","text":"ADSL List","href":"#isaiah/adsl/list"},{"link":true,"icon":"glyphicon glyphicon-list","text":"System List","href":"#proverbs/list"},{"divider":"divider"},{"link":true,"header":"dropdown-header","text":"Settings"},{"link":true,"icon":"glyphicon glyphicon-cog","text":"Configuration"},{"link":true,"icon":"glyphicon glyphicon-off","href":"#exodus/logoff","text":"Log Off"}];
